...
replace (
	github.com/open-policy-agent/frameworks/constraint => ../frameworks/constraint
...
require (
	...
	github.com/open-policy-agent/frameworks/constraint v0.0.0-20220411195332-0684e78d7c32
